...
39. [A367690](https://oeis.org/A367690)[SeqDB](https://sequenced.net/s/A367690)  Total number of steps of Euclid's GCD algorithm to calculate gcd(x,y) for all pairs x,y in the range 1 <= x,y <= n.