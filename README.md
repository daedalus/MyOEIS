...
100. [A380856](https://oeis.org/A380856) [SeqDB](https://sequencedb.net/s/A380856) In the binary expansion of n, arrange bits row-wise in a binary tree which is complete except for the last row and then read those bits in pre-order. [Graph](https://oeis.org/A380856/graph).[WolframAlpha: ListToCompleteBinaryTree](https://resources.wolframcloud.com/FunctionRepository/resources/ListToCompleteBinaryTree/)
